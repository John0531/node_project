...
const getSmoneyInfo = require('./getSmoneyInfo')
...
async function sendEmail(){
  ...
  try{
    ...
    // * 取得會員購物金資訊
    const smoneyInfo = await getSmoneyInfo()
    console.log(smoneyInfo)
    smoneyInfo.forEach((members) => {
      ...
      <body>
        <div style="text-align: center;">
          ...
          <div class="email-title">
            ...
            您的會員中心尚有$${members.smoney}購物金，請記得儘快使用噢!
          </div>
